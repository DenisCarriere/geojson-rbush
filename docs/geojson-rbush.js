 ...
 * //=fc
 */
var featureCollection$1 = function (features) {
 ...
 * var tree = rbush()
 */
var index = function (maxEntries) {
    var tree = index$8(maxEntries);
    /**
    ...
    tree.insert = function (feature) {
        feature.bbox = feature.bbox ? feature.bbox : index$2(feature);
        return index$8.prototype.insert.call(this, feature);
    };
    ...
    tree.search = function (geojson) {
        var search = index$8.prototype.search.call(this, this.toBBox(geojson));
    ...
    tree.collides = function (geojson) {
        return index$8.prototype.collides.call(this, this.toBBox(geojson));
    };
    ...
    tree.toBBox = function (geojson) {
        var bbox = geojson.bbox ? geojson.bbox : index$2(geojson);
        return {
            minX: bbox[0],
            minY: bbox[1],
            maxX: bbox[2],
